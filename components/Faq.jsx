          ...
          <div className="faq-content">
            <div className="faq-content__title">
              ...
              <p>
                ...
                on Our Website: Answers to Common Concerns and Inqui
              </p>
            </div>
            ...
            <div className="all-question">
              <div className="faq-box">
                ...
                >
                  <p>What is speacial about comparing rental car deals?</p>
                  <IconChevronDown />
                </div>
                <div className={`faq-box__answer ${getClassAnswer("q1")}`}>
              ...
              <div className="faq-box">
                ...
                <div className={`faq-box__answer ${getClassAnswer("q2")}`}>
              ...
              <div className="faq-box">
                ...
                <div className={`faq-box__answer ${getClassAnswer("q3")}`}>
